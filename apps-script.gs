...
function sendApplicantConfirmation(data) {
  ...
  var subject = 'Your application to the Software Engineering Bootcamp';
  var html = ''
    ...
    + '<p>Thank you for applying to the Software Engineering Bootcamp at ' + INSTITUTE_NAME + '. '
...
function sendAdminNotification(data, sheetUrl) {
  ...
  var html = ''
    ...
    + '<p>A new application was submitted to the Software Engineering Bootcamp.</p>'
    + '<table style="width:100%; border-collapse:collapse; margin:20px 0; font-size:14px;">'
    + summaryRow('Full Name', data.fullName)
    + summaryRow('Phone', data.phone)
    + summaryRow('Email', data.email)
